...
#define STRING_CONFIG_H_AUTHOR "(Daniel, Anet A8 SKR mini E3 V1.0 )" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 414 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.78, -13, -1.9 }
